...
thr = dm.benchmark.load_results(os.path.join(os.path.dirname(__file__), 'semantic_segmentation.py__benchmark_throughput*json'))
...
acc = load_results(os.path.join(os.path.dirname(__file__), 'semantic_segmentation_tesla-v100-sxm2-16gb_accuracy.json'))
...
with open(os.path.join(os.path.dirname(__file__), 'semantic_segmentation_throughputs.html'), 'wt') as f:
    f.write(html)