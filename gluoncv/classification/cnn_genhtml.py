...
thr = dm.benchmark.load_results(os.path.join(os.path.dirname(__file__), 'cnn.py__benchmark_throughput*json'))
...
acc = load_results(os.path.join(os.path.dirname(__file__), 'cnn_tesla-v100-sxm2-16gb_accuracy.json'))
...
with open(os.path.join(os.path.dirname(__file__), 'classification_throughputs.html'), 'wt') as f:
    f.write(html)
